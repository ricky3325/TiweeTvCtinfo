                    ...
                    children: [
                      Text(
                        ...
                        style: const TextStyle(
                            ...
                            color: Color.fromARGB(179, 179, 243, 2),//Ricky：時間戳記
                            fontSize: 15),
                      ),
                      Text(
                                  ...
                                  child: Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () => Navigator.push(
                                            ...
                                            /*Navigator.push(
                                            context, 
                                            MaterialPageRoute(builder: (context) => index == 0
                                              ? Player(
                                                url: "https://bloomberg-quicktake-1-lu.samsung.wurl.com/manifest/playlist.m3u8")
                                              : SortedByCategoryPage(
                                                      categoryName: channelCard
                                                          .state[index].name,
                                                      channels: data[channelCard
                                        ...
                                        child: BigCardChannels(//Ricky：取清單內容
                                          index: index,
                                          size: size,
